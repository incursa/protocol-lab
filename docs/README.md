...
ProtocolLab is a scenario-driven validation, benchmarking, and diagnostic
lab for modern transport protocols.

## Getting Started

- [Quickstart](quickstart.md) — bootstrap, build, and acceptance workflow
...
- [Product Boundaries](protocol-lab/product-boundaries.md) — public-candidate vs private/internal layer separation
...
- [Phase 2J Incursa H3 Performance Review](analysis/incursa-h3-phase2j-performance-review.md)
