...
verification artifact is `VER-PL-MEASUREMENT-CONTRACT-0001.json`.
...
- Measurement and artifact JSON Schemas exist under `schemas/measurement/v1/`
  and `schemas/artifact/v1/`.
